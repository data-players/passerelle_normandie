 ...
 * };
 */
declare const useQueryWithStore: <State extends ReduxState = ReduxState>(query: Query, options?: QueryOptions, dataSelector?: (state: State) => any, totalSelector?: (state: State) => number) => {
    data?: any;
    total?: number;
    error?: any;
    loading: boolean;
