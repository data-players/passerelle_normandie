...
var ResourceRoutes = function (_a) {
    ...
    return react_1.useMemo(function () {
        ...
        return (React.createElement(react_router_dom_1.Switch, null,
            create && (React.createElement(react_router_dom_1.Route, { path: basePath + "/create", render: function (routeProps) { return (React.createElement(WithPermissions_1.default, __assign({ component: create, basePath: basePath }, routeProps, props))); } })),
            show && (React.createElement(react_router_dom_1.Route, { path: basePath + "/:id/show", render: function (routeProps) { return (React.createElement(WithPermissions_1.default, __assign({ component: show, basePath: basePath, id: decodeURIComponent(routeProps.match.params
                        .id) }, routeProps, props))); } })),
            edit && (React.createElement(react_router_dom_1.Route, { path: basePath + "/:id", render: function (routeProps) { return (React.createElement(WithPermissions_1.default, __assign({ component: edit, basePath: basePath, id: decodeURIComponent(routeProps.match.params
                        .id) }, routeProps, props))); } })),
            list && (React.createElement(react_router_dom_1.Route, { path: "" + basePath, render: function (routeProps) { return (React.createElement(WithPermissions_1.default, __assign({ component: list, basePath: basePath }, routeProps, props))); } }))));
