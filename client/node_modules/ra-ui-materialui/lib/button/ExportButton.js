...
var ExportButton = function (props) {
    ...
    var _d = ra_core_1.useListContext(props), filterValues = _d.filterValues, resource = _d.resource, currentSort = _d.currentSort, exporterFromContext = _d.exporter, total = _d.total;
