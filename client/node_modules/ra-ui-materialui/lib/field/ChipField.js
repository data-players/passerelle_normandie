...
exports.ChipField = react_1.memo(function (props) {
    ...
    if (value == null && emptyText) {
        return (React.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), emptyText));
    }
    return (React.createElement(Chip_1.default, __assign({ className: classnames_1.default(classes.chip, className), label: value }, sanitizeRestProps_1.default(rest))));
});
