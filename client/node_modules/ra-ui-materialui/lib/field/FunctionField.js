 ...
 * />
 */
var FunctionField = react_1.memo(function (_a) {
    ...
    return record ? (React.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), render(record, source))) : null;
});
