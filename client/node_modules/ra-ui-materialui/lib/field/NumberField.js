...
exports.NumberField = react_1.memo(function (_a) {
    ...
    return (React.createElement(Typography_1.default, __assign({ variant: "body2", component: "span", className: className }, sanitizeRestProps_1.default(rest)), hasNumberFormat
