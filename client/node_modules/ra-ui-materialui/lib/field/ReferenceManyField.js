...
exports.ReferenceManyField = function (props) {
    ...
    return (react_1.default.createElement(ra_core_1.ListContextProvider, { value: controllerProps },
...
exports.ReferenceManyFieldView = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.cloneElement(react_1.Children.only(children), __assign(__assign({}, sanitizeRestProps_1.default(rest)), { basePath: basePath, resource: reference })),
        pagination &&
            props.total !== undefined &&
            react_1.cloneElement(pagination, rest)));
};
