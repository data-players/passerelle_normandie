...
var RichTextField = react_1.memo(function (_a) {
    ...
    return (React.createElement(Typography_1.default, __assign({ className: className, variant: "body2", component: "span" }, sanitizeRestProps_1.default(rest)), value == null && emptyText ? (emptyText) : stripTags ? (exports.removeTags(value)) : (React.createElement("span", { dangerouslySetInnerHTML: { __html: value } }))));
});
