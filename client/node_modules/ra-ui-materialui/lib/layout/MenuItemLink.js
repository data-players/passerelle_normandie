...
var MenuItemLink = react_1.forwardRef(function (props, ref) {
    ...
    var renderMenuItem = function () {
        return (react_1.default.createElement(MenuItem_1.default, __assign({ className: classnames_1.default(classes.root, className), activeClassName: classes.active, component: NavLinkRef, ref: ref }, rest, { onClick: handleMenuTap }),
