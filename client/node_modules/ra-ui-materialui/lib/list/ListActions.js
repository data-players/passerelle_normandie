...
var ListActions = function (props) {
    ...
    var _a = ra_core_1.useListContext(props), currentSort = _a.currentSort, resource = _a.resource, displayedFilters = _a.displayedFilters, filterValues = _a.filterValues, hasCreate = _a.hasCreate, basePath = _a.basePath, selectedIds = _a.selectedIds, showFilter = _a.showFilter, total = _a.total;
